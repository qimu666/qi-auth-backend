package com.qimu.qiauth.constant;
...
public interface EmailConstant {
     ...
     * 电子邮件标题
     */
    String EMAIL_TITLE = "赛友赛园";

    /**
     * 电子邮件标题英语
     */
    String EMAIL_TITLE_ENGLISH = "QiAuth";
     ...
     * 平台地址
     */
    String PLATFORM_ADDRESS = "<a href='https://saiyou.qimuu.icu/'>请联系我们</a>";

    String PATH_ADDRESS = "'https://saiyou.qimuu.icu/'";
}
